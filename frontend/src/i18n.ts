...
const zh: Record<string, string> = {
  ...
  'exportDiag': '导出诊断包', 'exportDiagDesc': '打包日志、设置及系统信息，用于问题排查',
  'exportDiagDoing': '打包中…', 'exportDiagDone': '已保存到 {path}', 'exportDiagFail': '导出失败',
...
const zhTW: Record<string, string> = {
  ...
  'exportDiag': '匯出診斷包', 'exportDiagDesc': '打包日誌、設定及系統資訊，用於問題排查',
  'exportDiagDoing': '打包中…', 'exportDiagDone': '已儲存至 {path}', 'exportDiagFail': '匯出失敗',
...
const en: Record<string, string> = {
  ...
  'exportDiag': 'Export Diagnostics', 'exportDiagDesc': 'Bundle logs, settings & system info for troubleshooting',
  'exportDiagDoing': 'Packaging…', 'exportDiagDone': 'Saved to {path}', 'exportDiagFail': 'Export failed',
